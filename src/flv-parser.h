...
typedef void (*metadata_callback)(pili_metadata_packet_p metadata_packet);
typedef void (*video_callback)(pili_video_packet_p v_packet);
typedef void (*audio_callback)(pili_audio_packet_p a_packet);
